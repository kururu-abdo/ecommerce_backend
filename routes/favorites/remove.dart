...
// final favoriteService = context.read<ProductService>();
  await favoriteService.removeFavorite(user.id.toString(), productId.toString());
  return Response.json(statusCode: 201, body: {'message': 'Product removed from favorites'});
}
